...
def main():
    ...
    stop_loss_percent = st.sidebar.number_input("enter the stop loss percentage", min_value=0.01, max_value=1.0)
    take_profit_percent = st.sidebar.number_input("enter the take profit percentage", min_value=0.01, max_value=1.0)
